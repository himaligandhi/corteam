            ...
            <div class="col-sm-6">
                ...
                <span id="formerror" class="error"></span>
                    <div class="half left cf">
                        <input type="text" id="input-name" placeholder="Enter your name" name="name" />
                        <input type="tel" id="input-phone" placeholder="Enter your Phone Number" name="phone"/>
				
                        <input type="email" id="input-email" placeholder="Enter your email" name="email" />
                    ...
                    <div class="icon">
                        ...
                        <div class="info">
                            ...
                            <p style="font-size:1.2em;">
                                <i class="fa fa-envelope" aria-hidden="true"></i>info@corfinancialcorp.com
                                <br>
                ...
                <div class="box">
                    <div class="icon">
                        ...
                        <div class="info">
                            ...
                            <p style="font-size:1.2em;">
                                <i class="fa fa-mobile" aria-hidden="true"></i> &nbsp (+1)-416-546-2859
                                <br>
